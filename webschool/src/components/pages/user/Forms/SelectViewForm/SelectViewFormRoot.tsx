...
export default function SelectViewFormRoot({ children, handleOnClick }: SelectViewFormRootProps) {
    return (
        <li onClick={handleOnClick} className="flex items-center space-x-3 py-2 px-4 rounded-md cursor-pointer border border-dashed border-zinc-200 dark:border-webschool-200 hover:bg-blue-200/50 dark:hover:bg-blue-200/5 transition-colors duration-150 group">
            {children}
