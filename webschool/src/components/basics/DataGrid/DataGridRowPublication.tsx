...
export default function DataGridRowPublication({ datas }: { datas: PublicationData[] }) {
            ...
            {datas.map((data, index: number) => (
                ...
                <td className="max-w-max px-4 py-2">
                    <div className="flex items-center justify-start gap-2 px-4 py-2">
                        ...
                        />
                        <div className="flex flex-col min-w-max mr-2">
                ...
                <td className="max-w-max px-4 py-2">
                    <span className="font-medium">
                        { data.nivel === "2" ? "Professor" : 
                        data.nivel === "1" && "Administrador"}
                    </span>
                ...
                <td>
                    <Link to={`/publication/${data.id}`}>
                        <span className="min-w-max text-sm text-zinc-400 dark:text-webschool-100 hover:underline hover:text-webschool-first">Ver Publicação</span>
                    </Link>
                </td>
